...
func TestLoadConfig(t *testing.T) {
	conf, err := NewConfig("testdata/bes-agent.conf", nil)
	...
	expectedConf := &Config{
		...
		LoggingConfig: LoggingConfig{
			LogLevel: "debug",
			LogFile:  "/tmp/bes-agent-testing.log",
		},
	}
